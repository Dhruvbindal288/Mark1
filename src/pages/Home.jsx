...
function Home() {
  return (
    <div id="/"  className="h-screen w-full bg-gradient-to-r from-[#00453ae6] via-[#008a78] to-green-400 pt-10 flex flex-col-reverse md:flex-row items-center justify-center text-center md:text-left">
      <div className="px-6 md:px-10 flex-5 md:flex-1">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white mt-5 md:mt-7 max-w-3xl mx-auto md:mx-0">
          MARK1 is a groundbreaking self-sustaining power <br /> generation
          system that creates a never-ending cycle of energy through intelligent
